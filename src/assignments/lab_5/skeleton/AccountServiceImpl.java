...
import assignments.lab_5.skeleton.Factory.AccountDAO;
import assignments.lab_5.skeleton.Factory.FactoryType;
import assignments.lab_5.skeleton.decorators.PThree;

import java.util.Collection;

import static assignments.lab_4.skeleton.Factory.AccountDaoStore.getAccountDao;

public class AccountServiceImpl implements AccountService {
	private AccountDAO accountDAO;
	
	public AccountServiceImpl(){
		accountDAO = getAccountDao(FactoryType.REAL);
	}
